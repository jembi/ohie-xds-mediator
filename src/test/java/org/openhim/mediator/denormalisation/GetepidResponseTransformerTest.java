...
public class GetepidResponseTransformerTest {
	...
	public void transformMessage_shouldextractAndSetUUIDAndAppropriateAssigningAuthority() throws TransformerException {
		...
		assertEquals(map.get(Constants.EPID_MAP_ID), "5b311c3b-67f3-4a7b-9a96-b2dd127af828");
		assertEquals(map.get(Constants.EPID_AUTHORITY_MAP_ID), "2.25");
	}
	...
	public void transformMessage_shouldextractAndSetOIDAndAppropriateAssigningAuthority() throws TransformerException {
		...
		assertTrue(object instanceof Map);
		Map<String, String> map = (Map<String, String>) object;
		assertEquals(map.get(Constants.EPID_MAP_ID), "55555");
		assertEquals(map.get(Constants.EPID_AUTHORITY_MAP_ID), "1.2.3");
	}
